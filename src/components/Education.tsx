  ...
  return (
    <section id="education" className="section-pad relative">
      <div className="container-px mx-auto max-w-6xl">
        <ScrollReveal>
          <span className="font-display text-sm uppercase tracking-[0.2em] text-violet">
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-2">
          <ScrollReveal>
            <div className="flex h-full items-start gap-4 rounded-2xl border border-line bg-surface-2/60 p-6">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-cyan/15 text-cyan">
                <FiBook size={20} />
              </div>
              <div>
          ...
          {certifications.map((cert, i) => (
            <ScrollReveal key={cert.name} delay={0.06 * (i + 1)}>
              <div className="flex h-full items-start gap-4 rounded-2xl border border-line bg-surface-2/60 p-6">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-pink/15 text-pink">
                  <FiAward size={20} />
                </div>
                <div>
